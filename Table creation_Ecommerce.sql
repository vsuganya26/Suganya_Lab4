...
create table if not exists supplier (SUPP_ID int primary key, SUPP_NAME varchar(50) NOT NULL, SUPP_CITY varchar(50) NOT NULL, SUPP_PHONE varchar(50) NOT NULL);
create table if not exists customer (CUS_ID int primary key, CUS_NAME varchar(20) NOT NULL, CUS_PHONE varchar(10) NOT NULL, CUS_CITY VARCHAR(30) NOT NULL, CUS_GENDER char);
...
create table if not exists supplier_pricing (PRICING_ID int NOT NULL, PRO_ID int NOT NULL, SUPP_ID int NOT NULL, primary key (PRICING_ID), foreign key (PRO_ID) REFERENCES product (PRO_ID), foreign key (SUPP_ID) REFERENCES supplier (SUPP_ID), SUPP_PRICE int default 0);
